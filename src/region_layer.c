...
{
    int i,j,n,z;
    /*  printf("Structure of output layer :\n");
	printf("l.w: %d, l.h: %d, l.batch : %d, l.outputs: %d, l.c: %d, l.activation: %s, l.classes: %d, l.coords: %d, l.n: %d\n",l.w,l.h,l.batch,l.outputs,l.c,l.activation,l.classes,l.coords,l.n);*/
